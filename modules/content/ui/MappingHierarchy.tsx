...
interface MappingHierarchyProps {
  mapping: VideoContentMappingWithHierarchy | MappingSuggestionType;
...
export function MappingHierarchy({
  ...
  // Check if this is a VideoContentMappingWithHierarchy or MappingSuggestionType
  if ("subBulletId" in mapping && mapping.subBulletId && mapping.subBullet) {
    // VideoContentMappingWithHierarchy with sub-bullet
    ...
    // VideoContentMappingWithHierarchy with bullet
    ...
    // VideoContentMappingWithHierarchy with objective only
    domain = mapping.objective.domain;
    objective = mapping.objective;
  } else {
    // MappingSuggestionType (simple structure)

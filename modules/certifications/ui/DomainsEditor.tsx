            ...
            <AccordionContent className="px-4 pb-4">
              <div className="space-y-2 pt-2">
                ...
                {domain.objectives.map((objective, objectiveIndex) => (
                  <Card key={objectiveIndex} className="p-3">
                    {editingObjective?.domainIndex === domainIndex && editingObjective?.objectiveIndex === objectiveIndex ? (
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              <span className="text-sm font-medium">{objective.code}</span>
                              <span className="text-xs px-2 py-0.5 rounded-full bg-primary/10 text-primary capitalize">
                                {objective.difficulty}
                              </span>
                            </div>
                            <p className="text-sm mt-1">{objective.description}</p>
                          </div>
                          {isEditable && (
                            <div className="flex gap-1">
                              <Button
                                size="icon"
                                variant="ghost"
                                onClick={() => handleEditObjective(domainIndex, objectiveIndex)}
                                className="h-6 w-6"
                              >
                                <Pencil className="h-3 w-3" />
                              </Button>
                              <Button
                                size="icon"
                                variant="ghost"
                                onClick={() => handleRemoveObjective(domainIndex, objectiveIndex)}
